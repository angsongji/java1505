...
public class view_chi_tiet_san_pham extends JPanel implements MouseListener {
	...
	public view_chi_tiet_san_pham (SanPhamDTO SanPhamDTO) {
		soluong = 1;
		
		this.SanPhamDTO = SanPhamDTO;
		this.SanPhamBUS = new SanPhamBUS();
		this.chitietsanphamBUS = new chitietsanphamBUS(SanPhamDTO);
		
		ArrayList<String> bangsize = chitietsanphamBUS.select_masize(SanPhamDTO);
		...
		try {
			h00 = "./src/images/"+this.SanPhamDTO.getTenHinh()[0];
			h01 = "./src/images/"+this.SanPhamDTO.getTenHinh()[1];
			
			h02 = "./src/images/"+this.SanPhamDTO.getTenHinh()[2];
...
//*************** panel north ***********///////////////////////////////////////
		...
		pn1 = new JPanel();
		pn1.setLayout(new FlowLayout(0));pn1.setBackground(Color.decode("#60A3BC"));
		jln1 = new JLabel("Chi tiết sản phẩm");
		pn1.add(jln1);
		
		pn2 = new JPanel();
		pn2.setLayout(new FlowLayout(2,0,0));pn2.setBackground(Color.decode("#60A3BC"));
		jln2 = new JLabel("X",jln2.CENTER); jln2.setPreferredSize(new Dimension(40,30));
		jln2.setFont(x);jln2.addMouseListener(this);
		pn2.add(jln2);
		pn.add(pn1);
		pn.add(pn2);
//**************************panel center*****************//////////////////////////////////////////		
		pc = new JPanel();pc.setLayout(new GridLayout(1,2));
		pcL = new JPanel();pcL.setLayout(new FlowLayout());
		...
		pc1[1].setPreferredSize(new Dimension(300,260));
			...
			//*************** hình lớn ****************///////////////////////////////////
		pc1[1].add(jlc1[0]);
		jlc1[0] = new JLabel(); jlc1[0].setPreferredSize(new Dimension(190,250));
		jlc1[0].setBackground(Color.white);jlc1[0].setOpaque(true);
		...
		jlc1[1] = new JLabel();jlc1[1].setPreferredSize(new Dimension(40,30));
		ImageIcon h1 = new ImageIcon(h01);
		jlc1[1].setIcon(h1);
		
		jlc1[2] = new JLabel();jlc1[2].setPreferredSize(new Dimension(40,30));
		ImageIcon h2 = new ImageIcon(h02);
		jlc1[2].setIcon(h2);
		
		jlc1[1].setBackground(Color.white);jlc1[2].setBackground(Color.white);
		jlc1[1].setOpaque(true);jlc1[2].setOpaque(true);
		pc1[2].add(jlc1[1]);
		pc1[2].add(jlc1[2]);
...
//***************** 7 dòng bên phải********************		
		...
		for (int i = 2; i <7;i++) {
			...
			pc2[i] = new JPanel();pc2[i].setLayout(new FlowLayout(0,10,0));
		...
		jlc2[0] = new JLabel("<html>" + SanPhamDTO.getTenSP() +"<html>" );jlc2[0].setFont(tensp);
		pc2[2].add(jlc2[0]);
		
//	////////////////////////////////////////	size S M L ///////////////////////////////////////////////////////////////////////

		jlc2[1] = new JLabel("M",JLabel.CENTER	);jlc2[1].setPreferredSize(new Dimension(40,30));
		jlc2[1].setBackground(Color.white); jlc2[1].setOpaque(true);jlc2[1].setFont(size);
		jlc2[1].addMouseListener(this);
		
		jlc2[2] = new JLabel("L",JLabel.CENTER);jlc2[2].setPreferredSize(new Dimension(40,30));
		jlc2[2].setBackground(Color.white); jlc2[2].setOpaque(true);jlc2[2].setFont(size);
		jlc2[2].addMouseListener(this);
		
		jlc2[3] = new JLabel("XL",JLabel.CENTER);jlc2[3].setPreferredSize(new Dimension(40,30));
		jlc2[3].setBackground(Color.white); jlc2[3].setOpaque(true);jlc2[3].setFont(size);
		...
		//////////////////// dấu trừ ///////////////////////////////////
		jlc2[5] = new JLabel("-",JLabel.CENTER);jlc2[5].setPreferredSize(new Dimension(40,20));
		jlc2[5].addMouseListener(this);
		jlc2[5].setBackground(Color.decode("#0A3D62"));jlc2[5].setOpaque(true);jlc2[5].setForeground(Color.white);
		
		///////////////////////////////// số lượng //////////////////////////
		jlc2[6] = new JLabel(soluong+"",JLabel.CENTER);jlc2[6].setPreferredSize(new Dimension(80,20));
		jlc2[6].setBackground(Color.white);jlc2[6].setOpaque(true);
		
		
		/////////////////////////// dấu cộng ///////////////////////////////////////////////
		jlc2[7] = new JLabel("+",JLabel.CENTER);jlc2[7].setPreferredSize(new Dimension(40,20));
		jlc2[7].setBackground(Color.decode("#0A3D62"));jlc2[7].setOpaque(true);jlc2[7].setForeground(Color.white);
		...
		jlc2[4] = new JLabel(this.SanPhamDTO.getPrice()*soluong+"");jlc2[4].setFont(tensp);
		pc2[5].add(jlc2[4]);
		...
		jlc2[8] = new JLabel("thêm vào giỏ",JLabel.CENTER);jlc2[8].setFont(giohang);
		jlc2[8].setForeground(Color.white);
		jlc2[8].setPreferredSize(new Dimension(100,30));
		jlc2[8].setBackground(Color.decode("#0A3D62"));jlc2[8].setOpaque(true);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (e.getSource() == jlc2[5]) {
			...
			jlc2[4].setText(this.SanPhamDTO.getPrice() * this.soluong +"");

...
public class StoreScreen extends JFrame {
    ...
    private void init() {
        ...
        // thanh dau tien cua chuong trinh gom: logo, ten cua hang, nut thanh chuong
        // trinh
        ...
        centerContent = new CenterContentStore(chieurong - (int) menu.getPreferredSize().getWidth() - 20,
                chieucao - 20 - (int) title_bar.getPreferredSize().getHeight(), this);
        // end

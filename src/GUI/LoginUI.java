...
public class LoginUI {
    ...
    private void createStorePanel() {
         ...
         * g.fillOval(getWidth() / 2 - radius, getHeight() / 2 - radius, 2 * radius, 2 *
         * radius);
         ...
         */// Đặt thành true nếu muốn hiển thị nền màu của storePanel
        JPanel logoPanel = new JPanel();
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (password.equals("")) {
                    ...
                    noBlank2.setText(
                            "<html>Chỉ được chứa kí tự số, chữ hoa<br>Chữ thường, kí tự đặc biệt: !, @</html>");
                ...
                // Lay duoc doi tuong TaikhoanDTO sau do khoi tao StoreScreen voi tham so la
                // TaikhoanDTO do

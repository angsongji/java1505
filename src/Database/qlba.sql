...
INSERT INTO `chucnang` VALUES ('TKCN','Tài khoản cá nhân'),('SP','Sản phẩm'),('GH','Giỏ hàng'),('LSHD','Lịch sử hóa đơn'),('NCC','Nhà cung cấp'),('QLNV','Quản lý nhân viên'),('QLTK','Quản lý tài khoản'),('QLKH','Quản lý khách hàng'),('QLPN','Quản lí phiếu nhập'),('PQ','Phân Quyền'),('DX','Đăng xuất');

...
INSERT INTO `chitietquyen` VALUES ('QNV','DX','Xem'),('QNV','GH','Sửa'),('QNV','GH','Xem'),('QNV','GH','Xóa'),('QNV','LSHD','In PDF'),('QNV','LSHD','Xem'),('QQLBH','LSHD','Sửa'),('QQLBH','LSHD','Xóa'),('QQLK','NCC','Export Excel'),('QQLK','NCC','Import Excel'),('QQLK','NCC','Sửa'),('QQLK','NCC','Thêm'),('QQLK','NCC','Xem'),('QQLK','NCC','Xóa'),('QQLHT','PQ','Sửa'),('QQLHT','PQ','Thêm'),('QQLHT','PQ','Xem'),('QQLHT','PQ','Xóa'),('QNV','QLKH','Sửa'),('QNV','QLKH','Xem'),('QQLBH','QLKH','Xóa'),('QQLK','QLPN','Export Excel'),('QQLK','QLPN','Import Excel'),('QQLK','QLPN','In PDF'),('QQLK','QLPN','Sửa'),('QQLK','QLPN','Thêm'),('QQLK','QLPN','Xem'),('QQLK','QLPN','Xóa'),('QQLHT','QLTK','Sửa'),('QQLHT','QLTK','Thêm'),('QQLHT','QLTK','Xem'),('QQLHT','QLTK','Xóa'),('QNV','SP','Xem'),('QQLBH','SP','Sửa'),('QQLK','SP','Export Excel'),('QQLK','SP','Import Excel'),('QQLK','SP','Thêm'),('QNV','TKCN','sửa'),('QNV','TKCN','Xem');
...
INSERT INTO `chucnang` VALUES ('TKCN','Tài khoản cá nhân'),('SP','Sản phẩm'),('GH','Giỏ hàng'),('LSHD','Lịch sử hóa đơn'),('NCC','Nhà cung cấp'),('QLTK','Quản lý tài khoản'),('QLKH','Quản lý khách hàng'),('QLPN','Quản lí phiếu nhập'),('PQ','Phân Quyền'),('DX','Đăng xuất');
...
INSERT INTO `hoadon` VALUES ('HD001','2023-08-13','KH003','NV003',1360000),('HD002','2023-07-22','KH006','NV003',270000);
INSERT INTO `khachhang` VALUES ('KH001','Tuấn Khùng',908112345,230),('KH002','Quỳnh Quỳnh',909112443,200),('KH003','Trịnh Trần Phương Tuấn',907545661,150),('KH004','Hà Lê',909887123,220),('KH005','Hương Võ',909700813,280),('KH006','Yến Hoàng',907661234,180);
INSERT INTO `loai` VALUES ('AF','Áo flannel',1),('AH','Áo Hoodie',1),('AK','Áo Khoác',1),('AL','Áo Len',0),('AN','Áo Nỉ',1),('ASM','Áo sơmi',1);
INSERT INTO `nhacungcap` VALUES ('NCC1','MLB',901123444),('NCC2','Supreme',907345556),('NCC3','OFF-WHITE ',909557689),('NCC4','LEVIS',907112580),('NCC5','Sakura',901558739);
INSERT INTO `nhanvien` VALUES ('AD001','Thanh Sang','Quản lí ứng dụng'),('NV001','Thanh Phương','Nhân viên bán hàng'),('NV002','Nhật Long','Nhân viên bán hàng'),('NV003','Oanh Le','Nhân viên bán hàng'),('QL001','Phương Uyên','Quản lí kho'),('QL002','Trí Anh','Quản lí bán hàng');
...
INSERT INTO `taikhoan` VALUES ('NV001','AD001','Phuong@','2023-09-14',1,'QNV'),('AD001','AD001','SangHard!','2023-02-13',1,'QQLHT'),('NV002','NV002','anhLong1111','2023-11-20',0,'QNV'),('NV003','NV003','Oanh2004!','2023-10-22',1,'QNV'),('QL001','QL001','PhuongUyen!','2023-09-01',1,'QNV'),('QL001','QL001','PhuongUyen!','2023-09-01',1,'QQLK'),('QL002','QL002','TriAnhhh','2023-06-22',1,'QNV'),('QL002','QL002','TriAnhhh','2023-06-22',1,'QQLBH');
--
